...
public class InputParametersService {
    ...
    public Populator getFieldsPopulator(Project project, IssueType issueType, CopyIssueBean source, Map<String, SystemFieldMapper> allSystemFieldMappers) {
    ...
    public static class Populator {
        ...
        public Populator(Project project, IssueType issueType, Map<String, SystemFieldMapper> allSystemFieldMappers, CopyIssueBean copyIssueBean, IssueInputParameters inputParameters, FieldMapperFactory fieldMapperFactory, FieldManager fieldManager, DefaultFieldValuesManagerImpl defaultFieldValuesManager) {
