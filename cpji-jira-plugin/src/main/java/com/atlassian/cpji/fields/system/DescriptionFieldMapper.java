 ...
 * @since v1.4
 */
public class DescriptionFieldMapper extends AbstractFieldMapper implements SystemFieldIssueCreationFieldMapper
{
    public DescriptionFieldMapper(final Field field)
    {
        super(field);
    }
